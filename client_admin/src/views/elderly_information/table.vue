	...
	<el-main class="bg table_wrap">
		<el-form label-position="right" :model="query" class="form p_4" label-width="120">
			<el-row>
					...
					<el-form-item>
						...
						<router-link v-if="user_group == '管理员' || $check_action('/elderly_information/table','add') || $check_action('/elderly_information/view','add')" class="el-button el-button--default el-button--primary search_btn_add" to="./view?">添加
						</router-link>
            			<el-button v-if="user_group == '管理员' || $check_action('/elderly_information/table','del') || $check_action('/elderly_information/view','del')" class="search_btn_del" type="danger" @click="delInfo()">删除</el-button>
					</el-form-item>
				</el-col>
		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			<el-table-column fixed type="selection" tooltip-effect="dark" width="55">
				...
				<el-table-column prop="elderly_users" @sort-change="$sortChange" label="老人用户"
				v-if="user_group == '管理员' || $check_field('get','elderly_users')" min-width="200">
						<template slot-scope="scope">
					{{ get_user_elderly_users(scope.row['elderly_users']) }}
				</template>
					</el-table-column>
					<el-table-column prop="family_members_of_the_elderly" @sort-change="$sortChange" label="老人家属"
				v-if="user_group == '管理员' || $check_field('get','family_members_of_the_elderly')" min-width="200">
						<template slot-scope="scope">
					{{ get_user_family_members_of_the_elderly(scope.row['family_members_of_the_elderly']) }}
				</template>
					</el-table-column>
			...
			<el-table-column fixed="right" label="操作" min-width="120" v-if="user_group == '管理员' || $check_action('/elderly_information/table','set') || $check_action('/elderly_information/view','set') || $check_action('/elderly_information/view','get') || $check_action('//table','add') || $check_action('//view','add')" >


				<template slot-scope="scope">
					<router-link class="el-button el-button--small is-plain el-button--success" style="margin: 5px !important;"
					v-if="user_group == '管理员' || $check_action('/elderly_information/table','set') || $check_action('/elderly_information/view','set') || $check_action('/elderly_information/view','get')"
	...
	export default {
		...
		data() {
			return {
				...
				showModal: false,
				// 获取数据地址
				url_get_list: "~/api/elderly_information/get_list?like=0",
				url_del: "~/api/elderly_information/del?",
		...
		methods: {
			...
			get_list_before(param){
				...
				if(user_group != "管理员"){
						let sqlwhere = "(";
										if(user_group=="老人用户"){
						sqlwhere+= "elderly_users = " + this.user.user_id + " or ";
					}
													if(user_group=="老人家属"){
						sqlwhere+= "family_members_of_the_elderly = " + this.user.user_id + " or ";
					}
