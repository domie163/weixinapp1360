		...
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
			...
			<el-col :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				...
				<el-form-item label="公司名称" prop="corporate_name">
												<el-input id="corporate_name" v-model="form_sub['corporate_name']" placeholder="请输入公司名称"
							  v-if="user_group === '管理员' || (form_sub['service_provider_id'] && $check_field('set','corporate_name')) || (!form_sub['service_provider_id'] && $check_field('add','corporate_name'))"></el-input>
					<div v-else-if="$check_field('get','corporate_name')">{{form_sub['corporate_name']}}</div>
											</el-form-item>
			</el-col>
				...
				<el-form-item label="公司地址" prop="company_address">
												<el-input id="company_address" v-model="form_sub['company_address']" placeholder="请输入公司地址"
							  v-if="user_group === '管理员' || (form_sub['service_provider_id'] && $check_field('set','company_address')) || (!form_sub['service_provider_id'] && $check_field('add','company_address'))"></el-input>
					<div v-else-if="$check_field('get','company_address')">{{form_sub['company_address']}}</div>
											</el-form-item>
			</el-col>
								<el-col v-if="user_group === '管理员' || $check_field('get','user_name') || $check_field('add','user_name') || $check_field('set','user_name')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="用户姓名" prop="user_name">
												<el-input id="user_name" v-model="form_sub['user_name']" placeholder="请输入用户姓名"
							  v-if="user_group === '管理员' || (form_sub['service_provider_id'] && $check_field('set','user_name')) || (!form_sub['service_provider_id'] && $check_field('add','user_name'))"></el-input>
