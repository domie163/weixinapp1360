<template>
  <view class="page_elderly_information diy_table diy_table_tml" id="elderly_information_table">
    <!-- 筛选模块(开始) -->
    <view>
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/elderly_information/view?" v-show="user_group == '管理员' || $check_action('/elderly_information/table','add') || $check_action('/elderly_information/view','add')">添加</navigator>
		...
		<view class="warp">
			<view class="container">
				<view v-for="(o,i) in list" class="row">
										<view v-if="0 && $check_field('get','elderly_users')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>老人用户</span>
								...
								<text>
									{{ get_user_elderly_users(o['elderly_users']) }}
								</text>
							</view>
										</view>
					</view>
													<view v-if="0 && $check_field('get','family_members_of_the_elderly')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>老人家属</span>
                          </view>
											<view class="diy_field diy_uid text">
								<text>
									{{ get_user_family_members_of_the_elderly(o['family_members_of_the_elderly']) }}
								</text>
							</view>
										</view>
					</view>
                            ...
                            <span>姓名</span>
								...
								<text>
									{{ o["full_name"] }}
													...
													<view v-if="1 && $check_field('get','gender')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>性别</span>
                          </view>
								...
								<text>
									{{ o["gender"] }}
													...
													<view v-if="1 && $check_field('get','age')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>年龄</span>
                          </view>
								...
								<text>
									{{ o["age"] }}
													...
													<view v-if="0 && $check_field('get','id_number')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>身份证号</span>
                          </view>
								...
								<text>
									{{ o["id_number"] }}
													...
													<view v-if="0 && $check_field('get','contact_information')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>联系方式</span>
                          </view>
								...
								<text>
									{{ o["contact_information"] }}
													...
													<view v-if="0 && $check_field('get','home_address')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>家庭住址</span>
                          </view>
                  ...
                  <view class="col">
                    <view class="view">
                      <view class="create_time_block diy_filed diy_time">
                        ...
                        <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/elderly_information/table','del') || $check_action('/elderly_information/view','del')">删除</button>
                      </view>
                    </view>
                  </view>
					<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/elderly_information/view?' + field + '=' + o[field]"
                               v-show="user_group == '管理员' || $check_action('/elderly_information/table','set') || $check_action('/elderly_information/view','set') || $check_action('/elderly_information/view','get')" class="btn btn-primary">详情</navigator>
	        					</view>
				</view>
			</view>
		</view>
