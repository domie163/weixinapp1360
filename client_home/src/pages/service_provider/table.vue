<template>
  <view class="page_service_provider diy_table diy_table_tml" id="service_provider_table">
    <!-- 筛选模块(开始) -->
    <view>
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/service_provider/view?" v-show="user_group == '管理员' || $check_action('/service_provider/table','add') || $check_action('/service_provider/view','add')">添加</navigator>
		...
		<view class="warp">
			<view class="container">
				<view v-for="(o,i) in list" class="row">
										<view v-if="1 && $check_field('get','corporate_name')" class="col">
						<view class="view">
                            ...
                            <span>公司名称</span>
								...
								<text>
									{{ o["corporate_name"] }}
													...
													<view v-if="1 && $check_field('get','company_address')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>公司地址</span>
                          </view>
                  ...
                  <view class="col">
                    <view class="view">
                      <view class="create_time_block diy_filed diy_time">
                        ...
                        <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/service_provider/table','del') || $check_action('/service_provider/view','del')">删除</button>
                      </view>
                    </view>
                  </view>
					<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/service_provider/view?' + field + '=' + o[field]"
                               v-show="user_group == '管理员' || $check_action('/service_provider/table','set') || $check_action('/service_provider/view','set') || $check_action('/service_provider/view','get')" class="btn btn-primary">详情</navigator>
	        					</view>
				</view>
			</view>
		</view>
