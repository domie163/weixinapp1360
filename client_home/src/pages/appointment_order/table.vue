                            ...
                            <span>公司名称</span>
								...
								<text>
									{{ o["corporate_name"] }}
													...
													<view v-if="1 && $check_field('get','service_name')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>服务名称</span>
                          </view>
								...
								<text>
									{{ o["service_name"] }}
													...
													<view v-if="1 && $check_field('get','service_type')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>服务类型</span>
                          </view>
								...
								<text>
									{{ o["service_type"] }}
													...
													<view v-if="1 && $check_field('get','service_price')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>服务价格</span>
                          </view>
								...
								<text>
									{{ o["service_price"] }}
													...
													<view v-if="0 && $check_field('get','appointment_users')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>预约用户</span>
                          </view>
								...
								<text>
									{{ get_user_appointment_users(o['appointment_users']) }}
								</text>
							</view>
										</view>
					</view>
                            ...
                            <span>老人用户</span>
								...
								<text>
									{{ get_user_elderly_users(o['elderly_users']) }}
													...
													<view v-if="0 && $check_field('get','time_of_appointment')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>预约时间</span>
                          </view>
								...
								<text>
									{{ $toTime(o["time_of_appointment"],"yyyy-MM-dd hh:mm:ss") }}
													...
													<view v-if="0 && $check_field('get','appointment_notes')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>预约备注</span>
                          </view>
								...
								<text>
									{{ o["appointment_notes"] }}
													...
													<view v-if="0 && $check_field('get','order_status')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>订单状态</span>
                          </view>
