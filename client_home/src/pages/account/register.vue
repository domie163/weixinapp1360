						...
						<view class="register_view">
							<uni-forms class="form_register" :rules="rules" :value="form" ref="form"
								...
								<uni-forms-item class="user_group" name="user_group" label="身份">
									...
									<!-- 老人用户 -->
								<form_elderly_users v-if="form.user_group === '老人用户'" @change="handleSubFormChange" :form="form_sub" ></form_elderly_users>
										<!-- 老人家属 -->
								<form_family_members_of_the_elderly v-if="form.user_group === '老人家属'" @change="handleSubFormChange" :form="form_sub" ></form_family_members_of_the_elderly>
...
<script>
	import mixin from "@/libs/mixins/page.js"
		/* 老人用户 */
	import form_elderly_users from "@/components/diy/form_elderly_users";
			/* 老人家属 */
	import form_family_members_of_the_elderly from "@/components/diy/form_family_members_of_the_elderly";
	...
	export default {
		components: {
			...
			form_elderly_users,
					/* 老人家属 */
			form_family_members_of_the_elderly,
											},
		mixins: [mixin],
		data() {
			return {
