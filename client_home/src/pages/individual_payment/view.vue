          ...
          <view class="">
            <uni-forms :modelValue="form"  v-if="is_view()">
              ...
              <uni-forms-item v-if="$check_field('get','insurance_name') || ($check_field('add','insurance_name') || $check_field('set','insurance_name'))" label="保险名称" name="insurance_name">
                            <uni-easyinput type="text" v-model="form['insurance_name']" v-if="user_group === '管理员' || (form['individual_payment_id'] && $check_field('set','insurance_name')) || (!form['individual_payment_id'] && $check_field('add','insurance_name'))" :disabled="disabledObj['insurance_name_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','insurance_type') || ($check_field('add','insurance_type') || $check_field('set','insurance_type'))" label="保险类型" name="insurance_type">
                            <uni-easyinput type="text" v-model="form['insurance_type']" v-if="user_group === '管理员' || (form['individual_payment_id'] && $check_field('set','insurance_type')) || (!form['individual_payment_id'] && $check_field('add','insurance_type'))" :disabled="disabledObj['insurance_type_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','insurance_price') || ($check_field('add','insurance_price') || $check_field('set','insurance_price'))" label="保险价格" name="insurance_price">
                            <uni-easyinput type="text" v-model="form['insurance_price']" v-if="user_group === '管理员' || (form['individual_payment_id'] && $check_field('set','insurance_price')) || (!form['individual_payment_id'] && $check_field('add','insurance_price'))" :disabled="disabledObj['insurance_price_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','purchasing_users') || ($check_field('add','purchasing_users') || $check_field('set','purchasing_users'))" label="购买用户" name="purchasing_users">
                  ...
                  v-if="user_group === '管理员' || (form['individual_payment_id'] && $check_field('set','purchasing_users')) || (!form['individual_payment_id'] && $check_field('add','purchasing_users'))"
                ></uni-data-select>
                <uni-data-select
                  v-model="form['purchasing_users']"
                  :localdata="list_user_purchasing_users"
              ...
              <uni-forms-item v-if="$check_field('get','user_name') || ($check_field('add','user_name') || $check_field('set','user_name'))" label="用户姓名" name="user_name">
                            <uni-easyinput type="text" v-model="form['user_name']" v-if="user_group === '管理员' || (form['individual_payment_id'] && $check_field('set','user_name')) || (!form['individual_payment_id'] && $check_field('add','user_name'))" :disabled="disabledObj['user_name_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','purchase_date') || ($check_field('add','purchase_date') || $check_field('set','purchase_date'))" label="购买日期" name="purchase_date">
                    <uni-datetime-picker v-if="user_group === '管理员' || (form['individual_payment_id'] && $check_field('set','purchase_date')) || (!form['individual_payment_id'] && $check_field('add','purchase_date'))" v-model="form['purchase_date']" type="date" :disabled="disabledObj['purchase_date_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','remarks') || ($check_field('add','remarks') || $check_field('set','remarks'))" label="备注信息" name="remarks">
                    <uni-easyinput type="textarea" v-model="form['remarks']" v-if="user_group === '管理员' || (form['individual_payment_id'] && $check_field('set','remarks')) || (!form['individual_payment_id'] && $check_field('add','remarks'))" :disabled="disabledObj['remarks_isDisabled']" />
                <!-- 仅查看 -->
